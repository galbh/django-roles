...
STATIC_URL = '/static/'
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'frontend', 'core-app', 'admin', 'dist'),
    os.path.join(BASE_DIR, 'frontend', 'core-app', 'god', 'dist'),
    os.path.join(BASE_DIR, 'frontend', 'core-app', 'anonymous', 'dist'),
